...
it('the array must be filtered by the given parameters', () => {
    //1. test data
    let action = filterGoods({ forBody: ['Крема для тела'] });
...
it('the filtered array should be cleared', () => {

    //1. test data
    let action = clearFilters();
